...
$('#sugerencias').click(function () {
	...
	//$('.rescataletras').click(getStarted);
...
// Mueve astronautas en la portada
function mueveObj(obj, time, t1, l1, t2, l2, t3, l3, clase){
	timeout(obj, time, t1, l1, t2, l2, t3, l3, clase);
	setInterval(function(){
		timeout(obj, time, t1, l1, t2, l2, t3, l3, clase);
	}, time*3);
}

function timeout(obj, time, t1, l1, t2, l2, t3, l3, clase){
	setTimeout(function(){
		$(obj).animate({
			top: t1,
			left:  l1
